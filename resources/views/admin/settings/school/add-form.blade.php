    ...
    <section class="container-fluid">
        <div class="row content">
            <div class="col-md-8 offset-md-2 pl-0 pr-0">
                ...
                <form action="{{route('school-name-save')}}" method="post" enctype="multipart/form-data">
                    @csrf
                            ...
                            <tr>
                                <td>
                                    <div class="form-group row mb-0">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control @error('add_school') is-invalid @enderror" name="add_school" value="{{ old('add_school') }}" id="slideTitle" placeholder="add school name here" required>
                                            @error('add_school')
