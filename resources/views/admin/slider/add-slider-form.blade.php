                            ...
                            <tr>
                                <td>
                                    <div class="form-group row mb-0">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control @error('slide_title') is-invalid @enderror" name="slide_title" value="{{ old('slide_title') }}" id="slideTitle" placeholder="Write slide title here" required>
                                            @error('slide_title')
                                            <span class="invalid-feedback" role="alert"><strong>{{ $message }}</strong></span>
                                            @enderror
                                        </div>
                            ...
                            <tr>
                                <td>
                                    <div class="form-group row mb-0">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control @error('slide_description') is-invalid @enderror" name="slide_description" id="slideDescription" placeholder="Write slide description here" value="{{ old('slide_description') }}" required>
