        ...
        <div class="row content">
            <div class="col-md-8 offset-md-2 pl-0 pr-0">
                ...
                <div class="form-group">
                    <div class="col-sm-12">
                        <h4 class="text-center font-weight-bold font-italic mt-3">Slide Update Form</h4>
                    </div>
                </div>
                ...
                <form action="{{route('update-slide')}}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="table-responsive p-1">
                        <table id="" class="table table-bordered dt-responsive nowrap text-center" style="width: 100%;">
                            <tr><td><img src="{{asset('/')}}{{$slides->slide_image}}" alt="" id="slide_show" style="max-height: 244px"></td></tr>
                            <tr>
                                <td>
                            ...
                            <tr>
                                <td>
                                    <div class="form-group row mb-0">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control @error('slide_title') is-invalid @enderror" name="slide_title" value="{{$slides->slide_title}}" id="slideTitle" placeholder="Write slide title here" required>
                                            @error('slide_title')
                                            <span class="invalid-feedback" role="alert"><strong>{{ $message }}</strong></span>
                                            @enderror
                                        </div>
                            ...
                            <tr>
                                <td>
                                    <div class="form-group row mb-0">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control @error('slide_description') is-invalid @enderror" name="slide_description" id="slideDescription" placeholder="Write slide description here" value="{{$slides->slide_description}}"required >
                                ...
                                <td>
                                    <div class="form-group row mb-0">
                                        ...
                                        <div class="col-sm-9 text-left">
                                            ...
                                            <div class="form-check col-form-label">
                                                <input class="form-check-input" type="radio" name="status" value="0"{{$slides->status == 0 ? 'checked' : ''}}>
