...
<head>
    ...
    <title>Unity Mess | Login Form</title>
...
<section class="container-fluid">
    <div class="row content login-form">
        <div class="col-12 pl-0 pr-0">
            ...
            <form action="{{ route('login') }}" method="post" enctype="multipart/form-data" autocomplete="" class="form-inline">
                @csrf
                <div class="form-group col-12 mb-3">
                    <label for="fatherMobile" class="col-sm-3 col-form-label text-right">E-mail</label>
                    <input type="email" name="email" placeholder="Email" class="form-control col-sm-9 @error('email') is-invalid @enderror" value="{{ old('email') }}" id="fatherMobile" minlength="8" required>
